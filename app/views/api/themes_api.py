...
@api_view.route("/themes/<theme_id>")
...
@api_view.route("/themes/<theme_id>/poems")
...
@api_view.route("/themes", methods=["POST"])
# @login_required
def create_theme():
    """Create a new theme.
...
@api_view.route("/poems/<poem_id>/themes/<theme_id>", methods=["POST"])
# @login_required
...
@api_view.route("/poems/<poem_id>/themes/<theme_id>", methods=["DELETE"])
# @login_required
