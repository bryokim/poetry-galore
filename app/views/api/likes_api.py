...
@api_view.route("/poems/<poem_id>/likes")
        ...
        jsonify(
            {
                ...
                "poems": [
                    url_for(
                        "api_view.get_poem", poem_id=poem_id, _external=True
                    )
...
@api_view.route("/poems/<poem_id>/like")
@login_required
...
@api_view.route("/poems/<poem_id>/unlike")
@login_required
