...
@api_view.route("/poems/<poem_id>/comment")
...
@api_view.route("/poems/<poem_id>/comments", methods=["POST"])
@login_required
...
@api_view.route("/poems/<poem_id>/comments/<comment_id>/update")
@login_required
...
@api_view.route("/poems/<poem_id>/comments/<comment_id>/delete")
@login_required
