...
@api_view.route("/poems/create", methods=["GET", "POST"])
@login_required
def create_poem():
    """Post a poem.
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for("api_view.get_poem", poem_id=new_poem.id))
...
@api_view.route("/poems/<poem_id>/update", methods=["GET", "POST"])
@login_required
def update_poem(poem_id: str):
    ...
    if request.method == "POST" and form.validate_on_submit():
        ...
        return redirect(url_for("api_view.get_poem", poem_id=poem.id))
    else:
        category_name = ""
        if poem.category:
...
@api_view.route("/poems/<poem_id>/delete")
@login_required
