...
@api_view.route("/users/validate/username/<username>")
...
@api_view.route("/users/validate/email/<email>")
...
@api_view.route("/users/update", methods=["GET", "POST"])
@login_required
def update_user():
    """Update a user.
...
@api_view.route("/users/<user_id>", methods=["DELETE"])
@login_required
