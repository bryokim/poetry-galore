...
@api_view.route("/categories/<category_id>")
...
@api_view.route("/categories/<category_id>/poems")
...
@api_view.route("/categories", methods=["POST"])
def create_category():
...
@api_view.route("/poems/<poem_id>/categories/<category_id>", methods=["POST"])
